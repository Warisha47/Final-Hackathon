...
const OurProducts = () => {
  return (
      ...
      <section className="bg-white dark:bg-gray-900 w-[1020px] h-[919px] ml-[100px] flex justify-center -mt-[367px]">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="max-w-screen-md mb-8 lg:mb-16">
            <h2 className="-mb-9 text-[24px] tracking-tight font-semibold text-[#272343] flex justify-evenly dark:text-white">
              Our Products
            </h2>
          </div>
...
{/* 6 */}
            <div className="flex flex-col items-center">
              <Image className="w-full h-48 object-cover rounded-lg" src="/images/graychair.png" alt="Image 2" width={300} height={300} />
              <div className="mt-2 text-start">
                <p className="text-base text-[#007580] font-normal text-start mr-28">Library Stool Chair</p>
                <p className="text-lg text-[#272343]">$20</p>
              </div>
...
{/* 7 */}
            <div className="flex flex-col items-center">
              <Image className="w-full h-48 object-cover rounded-lg" src="/images/black chair.png" alt="Image 2" width={300} height={300} />
              <div className="mt-2 text-start">
                <p className="text-base text-[#007580] font-normal text-start mr-28">Library Stool Chair</p>
                <p className="text-lg text-[#272343]">$20</p>
              </div>
...
{/* 8 */}
            <div className="flex flex-col items-center">
              <Image className="w-full h-48 object-cover rounded-lg" src="/images/Image.png" alt="Image 3" width={300} height={300} />
              <div className="mt-2 text-start">
                <p className="text-base text-[#007580] font-normal text-start mr-28">Library Stool Chair</p>
                <p className="text-lg text-[#272343]">$20</p>
              </div>
